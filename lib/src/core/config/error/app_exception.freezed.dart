...
mixin _$AppException {
  CacheExceptionType get type => throw _privateConstructorUsedError;
  String? get message => throw _privateConstructorUsedError;
  int? get code => throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function(
      CacheExceptionType type,
      String? message,
      int? code,
    )
    cacheException,
...
class _$CacheExceptionImpl implements CacheException {
  const _$CacheExceptionImpl({required this.type, this.message, this.code});
